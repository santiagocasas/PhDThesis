...
\section{Correlation functions and the power spectrum \comm{3.1, 3.2 can probably be deleted. }}
\begin{itemize}
...
\section{Fisher Matrix formalism \comm{Please don't rewrite the text we had already in papers: You can cut/paste the fisher formalism from the last paper (including FoM, FoC) and put it here. Don't mix up the text, modify the text we already have as little as possible,}}
%\begin{itemize}
