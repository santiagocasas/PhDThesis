...
deal with two such theories: The Coupled Dark Energy model, which couples Dark Matter to a scalar field (\cref{see}) and Growing Neutrino Quintessence, in which the neutrino mass is coupled to
the ``cosmon`` scalar field.
...
\subsubsection{Formalism of growing neutrinos with varying coupling}
