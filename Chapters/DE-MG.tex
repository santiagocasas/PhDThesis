...
In the case of universal coupling (see \cref{sec:universal-coupling} below), all metrics would be identical $\hat{g}^{(i)} = g^{(i)}$. \todo{change this g hat thing
and rewrite the formalism}
...
for dynamical dark energy. \todo{add the m-nu argument w=-1+12 ev}
