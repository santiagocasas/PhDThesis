...
the fine-tuning has to be performed at each higher order in quantum field perturbation theory (see the excellent review by \mcite{Jerome, Martin}). One has to find a powerful symmetry that
...
\textcolor{red}{\textsc{Section still Incomplete: Needs Poisson and stress equation}}
%\begin{itemize}
