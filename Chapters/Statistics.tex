...
This in turn will make \comm{decide the tense; preferably se present everywhere} the data covariance matrix $\mathbf{C}$ in Fourier space not diagonal anymore and  \revtext{the analysis of cosmological observations more difficult.}
...
\comm{I would start the paragraph from here; avoid this very general comment on what is important, they are too vague and subjective} If an experiment yields a vector of random variables $x^i$, 
we have to
...
\comm{how is this different from 3.3.1, I would merge Fisher formalism and fisher forecast sections}
