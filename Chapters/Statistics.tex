...
\subsubsection{Equations for the power spectrum}
...
\beeqp$
\sigma_{R}^2=\sigma_{8}^{2}
$
The quantity
$\sigma_{8}$ is a quantity defined always at $z=0$ and only in linear theory, which means
that in \cref{eq:normalizationPk} either $P(k,z=0)$ is the linear one
