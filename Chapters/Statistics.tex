...
This in turn will make \comm{decide the tense; preferably se present everywhere} the data covariance matrix $\mathbf{C}$ in Fourier space not diagonal anymore and 
