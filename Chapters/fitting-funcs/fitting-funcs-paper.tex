...
\done\todo{check for repetitions}
...
In this chapter, we will use N-Body simulations to find fitting functions
...
The aim of this work is to create fitting functions which are valid
...
The power spectrum computation embedded in \textsc{GADGET-3}
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.45\columnwidth]{Chapters/fitting-funcs/figures/ratioPk-z000}
\includegraphics[width=0.45\columnwidth]{Chapters/fitting-funcs/figures/ratioPk-z055}\\
\includegraphics[width=0.45\columnwidth]{Chapters/fitting-funcs/figures/ratioPk-z100}
\includegraphics[width=0.45\columnwidth]{Chapters/fitting-funcs/figures/ratioPk-z161} 
\par\end{centering}
...
\done\todo{remove fitting functions part}
...
beyond \done\todo{correct table size or move to appendix} the Nyquist frequency (for our second case) contribute to the
...
\done\todo{check for repetitions and maybe remove some unneeded plots} 
...
The first part of this chapter has then been devoted to the task of
