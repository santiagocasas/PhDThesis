...
of appendix A in the publication \cite{casas_dynamics_2016-1}.}
\end{sidewaystable}
\normalsize
...
algorithm that solves the Poisson equation  \ref{eq:relativistic-Poisson} 
...
In table II of appendix A in the publication \cite{casas_dynamics_2016-1},
...
this behavior in the left panel of \cref{fig:Snapshots-of-models-oscill}.
...
of redshift distance measurements). In appendix B of the publication \cite{casas_fitting_2016},
