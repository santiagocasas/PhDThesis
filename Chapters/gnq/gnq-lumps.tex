\chapter{Growing Neutrino Quintessence}
...
\section{Growing neutrinos with varying coupling}
...
\hline 
\end{tabular}\protect\protect\protect\caption{\label{tab:simus-params} Table of parameters for the six models considered
...
\begin{equation}
f_{\nu}(\mathbf{x},\mathbf{v})=\bar{n}_{\nu}f_{FD}(|\mathbf{v}_{\nu}-\mathbf{v_{pec\mathbf{,}\nu}}(\mathbf{x})|)(1+\delta_{v}(\mathbf{x}))\,\,\,,\label{eq:thermal-velocities}
\end{equation}
...
\protect\protect\protect\caption{\label{fig:Snapshots-of-models-oscill}Snapshots of the number density
contrast\textbf{ }of neutrinos $\delta n_{\nu}(\vec{x})\equiv n_{\nu}(\vec{x})/\bar{n}_{\nu}-1$
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.35\textwidth]{Chapters/gnq/figures/model325-crash0062-1-leg}\includegraphics[width=0.35\textwidth]{Chapters/gnq/figures/model5-crash065-1-noleg} 
\par\end{centering}

\protect\protect\protect\protect\protect\protect\protect\caption{\label{fig:Snapshots-of-models-crashing}Snapshots of the neutrino
...
\begin{figure}
\centering{}\includegraphics[width=0.75\textwidth]{Chapters/gnq/figures/Background-model2-gnq-And-CAMB_OmegaFluidQNu-and-OmegaNu-v1}\protect\caption{\label{fig:bckg-mod2-1}Evolution of $\Omega_{\phi+\nu}$ (blue lines)
...
\begin{figure}
\centering{}\includegraphics[width=0.75\textwidth]{Chapters/gnq/figures/Background-model2-gnq-And-CAMB_wnu-and-wqnu-v1}\protect\caption{\textbf{\label{fig:backg-wnu-wqnu-mod2}} Equation of state of the
...
\protect\protect\protect\protect\protect\protect\caption{\textbf{\label{fig:NuMass-mod2}}Neutrino mass $\overline{m}_{\nu}$
...
\begin{figure}
\begin{centering}
\includegraphics[width=0.49\textwidth]{Chapters/gnq/figures/momentum-Histogram-FD-model1-v4}\includegraphics[width=0.49\textwidth]{Chapters/gnq/figures/momentum-Histogram-FD-model2-v4} 
\par\end{centering}

\protect\protect\caption{\label{fig:histogram-FermiD-1} Distribution of the momenta of the
...
\begin{figure}
\centering{}\includegraphics[width=0.7\textwidth]{Chapters/gnq/figures/Phi-GravPotSpec-M2-and-M5-at-006500-Phit_Phinu-new}\protect\caption{\label{fig:gravpot-in-scale} Power spectra of the total gravitational
...
\begin{figure}
\centering{}\includegraphics[width=0.7\textwidth]{Chapters/gnq/figures/Phi-GravPotSpec-InTime-M2-and-M5-2scales-Phinu_Phim-new}\protect\caption{\label{fig:gravpot-intime1} Power spectra of the matter gravitational
...
\caption{\label{fig:lineout-gravpotnu} 
...
\hline 
\end{tabular}\protect\protect\protect\caption{\label{tab:CAMB-inipars-1} Table of initial parameters for each model
...
\hline 
\end{tabular}\protect\protect\protect\caption{\label{tab:Nbody-inipars-1-1} Table of numerical parameters for each
...
\begin{figure}
\centering{}\includegraphics[width=0.85\textwidth]{Chapters/gnq/figures/wDEmeasured-nuphi-modelM1}\protect\protect\protect\caption{\label{fig:Wnuphi-Wde-model2} Different $w(z)$ curves in the case
