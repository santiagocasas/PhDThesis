...
in the linear and mildly non-linear regimes (for some examples of recent MG forecasts, see \cite{amendola_cosmology_2013, casas_fitting_2016,  bielefeld_cosmological_2014}).
...
\cite{casas_fitting_2016,saracco_non-linear_2010,vollmer_efficient_2014}
...
\cite{casas_fitting_2016,takahashi_revising_2012,bird_massive_2011}.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|}
		...
		\hline 
	\end{tabular}\protect\caption[Fiducial parameters for the forecasted EFT model.]{Fiducial model used for the EFT parametrization. 
