...
with upcoming surveys, namely Euclid, SKA and DESI.
We also determine the best combination of redshift-binned Modified Gravity parameters constrained by forthcoming surveys.
...
magnitude the constraints obtained only with linear theory.
...
The main message of this thesis is that non-linear structure formation has a significant impact on cosmology and if we want to discriminate between competing theories, using upcoming data, 
