...
We also find the best combination of Modified Gravity parameters constrained by future surveys.
For Growing Neutrino Quintessence we show for the first time different oscillation regimes for neutrino lumps depending on their masses and we find a heating of the neutrino fluid, using special N-body simulations. In the case of Horndeski models, we apply for the first time a resummation method valid in the quasistatic regime.
The main message of this work is that non-linear structure formation has a significant impact on cosmology and if in the future we want to discriminate between competing cosmological models, 
we need to understand and take non-linearities into account.
